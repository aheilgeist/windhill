...
function tinyframework_setup() {
	...
	register_nav_menus(	array(
		'primary' => esc_html__( 'Primary Menu', 'tinyframework' ),
		'social'  => esc_html__( 'Social Links Menu', 'tinyframework' ),
	) );
...
function tinyframework_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'tinyframework_content_width', 640 );
}
...
function tinyframework_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Main Sidebar', 'tinyframework' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Appears on posts and pages except the optional Front Page template, which has its own widgets', 'tinyframework' ),
	...
	register_sidebar( array(
		'name'          => esc_html__( 'First Front Page Widget Area', 'tinyframework' ),
		'id'            => 'sidebar-2',
		'description'   => esc_html__( 'Appears when using the optional Front Page template with a page set as Static Front Page', 'tinyframework' ),
		'before_widget' => '<section id="%1$s" class="widget %2$s">',
		'after_widget'  => '</section>',
		'before_title'  => '<h3 class="widget-title">',
		'after_title'   => '</h3>',
	...
	register_sidebar( array(
		'name'          => esc_html__( 'Second Front Page Widget Area', 'tinyframework' ),
		'id'            => 'sidebar-3',
		'description'   => esc_html__( 'Appears when using the optional Front Page template with a page set as Static Front Page', 'tinyframework' ),
		'before_widget' => '<section id="%1$s" class="widget %2$s">',
		'after_widget'  => '</section>',
	...
	register_sidebar( array(
		'name'          => esc_html__( 'First Footer Widget Area', 'tinyframework' ),
		'id'            => 'sidebar-4',
		'description'   => esc_html__( 'Found at the bottom of every page (except 404s) as the footer. Left Side.', 'tinyframework' ),
		'before_widget' => '<section id="%1$s" class="widget %2$s">',
		'after_widget'  => '</section>',
		'before_title'  => '<h3 class="widget-title">',
		'after_title'   => '</h3>',
	...
	register_sidebar( array(
		'name'          => esc_html__( 'Second Footer Widget Area', 'tinyframework' ),
		'id'            => 'sidebar-5',
		'description'   => esc_html__( 'Found at the bottom of every page (except 404s) as the footer. Center.', 'tinyframework' ),
		'before_widget' => '<section id="%1$s" class="widget %2$s">',
		'after_widget'  => '</section>',
		'before_title'  => '<h3 class="widget-title">',
		'after_title'   => '</h3>',
	...
	register_sidebar( array(
		'name'          => esc_html__( 'Third Footer Widget Area', 'tinyframework' ),
		'id'            => 'sidebar-6',
		'description'   => esc_html__( 'Found at the bottom of every page (except 404s) as the footer. Right Side.', 'tinyframework' ),
		'before_widget' => '<section id="%1$s" class="widget %2$s">',
		'after_widget'  => '</section>',
		'before_title'  => '<h3 class="widget-title">',
		'after_title'   => '</h3>',
	...
	register_sidebar( array(
		'name'          => esc_html__( 'Footer Copyright Widget Area', 'tinyframework' ),
		'id'            => 'sidebar-7',
		'description'   => esc_html__( 'Found at the bottom of every page as the footer. Left Side. Use Text widget with no Title.', 'tinyframework' ),
		'before_widget' => '<section id="%1$s" class="widget %2$s">',
		'after_widget'  => '</section>',
	) );
}
...
function tinyframework_scripts_styles() {
	...
	$translation_array = array(
		'newWindow'    => esc_html__( 'Opens in a new window', 'tinyframework' ),
	);
...
function tinyframework_display_credits() {
	$text = sprintf( esc_html__( 'Using %s', 'tinyframework' ), '<a href="http://mtomas.com/1/tiny-forge-free-mobile-first-wordpress-theme">Tiny Framework</a> ' );
