...
== Description ==
Tiny Framework WordPress theme was created with the future in mind and encompasses all the best features of the default WordPress themes in one place, adds full accessibility and Schema.org microdata format support. Fast start is ensured with very extensive documentation!
...
Tiny Framework can be used as a learning tool or your own little web development "framework" a.k.a. "starter theme". With its unique "Coding Tips System" Tiny Framework helps to understand how to extend parent themes and build your own child themes, hacking them the way you want. Along with the main theme you will find an example of a child theme - an easy way to start developing with child themes! You get the best coding examples from default WordPress themes and the best hacks from the child theme. Theme supports Site Logo feature on WordPress.com, that is available with Jetpack plugin for self-hosted sites (can be also installed as a stand-alone plugin).
...
for that purpose I included an example of a child theme with main Tiny Framework download under inc/examples/tiny-framework-child.zip.
...
French (Français) - not complete - big thanks to Dolordo http://wordpress.org/support/profile/dolordo

German (Deutsch) - big thanks to Ralph Stieber http://www.happy-end-buecher.de/wissenswertes/impressum/

Hebrew (עִבְרִית) - not complete
...
Portuguese (Brazil) (Português do Brasil) - not complete
...
Underscores    - 1.0 - 2015-07-03 - https://github.com/Automattic/_s/
Twenty Twelve  - 1.6 - 2015-07-03 - https://core.trac.wordpress.org/browser/trunk/src/wp-content/themes/twentytwelve?order=date&desc=1
Twenty Fifteen - 1.0 - 07-03 - https://core.trac.wordpress.org/browser/trunk/src/wp-content/themes/twentyfifteen?order=date&desc=1


Other components:
-----------------

normalize.css             - 3.0.3     - 2015-06-16 - Initial rules for style.css             - https://github.com/necolas/normalize.css
Font Awesome              - 4.3.0     - 2015-06-16 - Webicon font                            - http://fontawesome.io
Theme Hook Alliance hooks - 1.0-draft - 2015-06-16 - Custom hooks                            - https://github.com/zamoose/themehookalliance
html5shiv                 - 3.7.3-pre - 2015-06-16 - HTML5 compatibility for legacy browsers - https://github.com/aFarkas/html5shiv
Bootstrap                 - 3.3.5     - 2015-06-16 - CSS for Alert and Button elements       - http://getbootstrap.com


Plugin compatibility:
---------------------

Link Manager              - 0.1-beta  - 2015-05-28 - http://wordpress.org/plugins/link-manager/
Jetpack                   - 3.5.3     - 2015-05-28 - Site Logo, Infinite Scroll, Sharing  - https://github.com/Automattic/jetpack , http://jetpack.me
...
### Release info
- Release time investment (Development & QA):  h.
- Free theme support time investment:  h.
- Theme documentation time investment:  h.
